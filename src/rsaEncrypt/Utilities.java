...
/**
 * Utilities used in RSA scheme. Includes a primality test, gcd calculator, modular
 * exponentiation O(log n), modular inversion
 * 
...
public final class Utilities {
	...
	/**
	 * This parameter determines the probability of a false positive in the implementation
	 * of the isPrime primality test. That probability is given by 4^-primalityParam. Thus
	 * the current tuning of 10 gives probability of a false positive on the order of
	 * 10^-603
	 */
	...
	public static boolean isPrime(int test){
		...
		for (int i = 0; i < primalityParam; i++) {
			...
			if ((x == 1) || (x == test - 1)) continue; // relatively prime here; to to next loop
																									// iteration
